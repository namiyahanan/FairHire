  ...
  return (
    <DashboardLayout>
      ...
      <div className="space-y-8">
        ...
        {/* ================= CHEATSHEET SLIDE-OVER DRAWER ================= */}
        {activeCheatsheetDrawer && (
          <div className="fixed inset-0 z-50 flex justify-end">
            {/* Backdrop */}
            <div 
              className="absolute inset-0 bg-navy-950/60 backdrop-blur-sm transition-opacity animate-in fade-in"
            ...
            <div className="relative w-full max-w-2xl bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
              ...
              <div className="p-6 border-b border-slate-100 bg-slate-50 flex items-center justify-between shrink-0">
                <div>
                  <h3 className="text-xl font-black text-navy-900 tracking-tight">
                    MNC Selection Process Blueprint
                  </h3>
                  <p className="text-sm text-slate-500 mt-1">
                    Complete preparation guide for multi-phase interviews
                  </p>
                </div>
                <button
                  type="button"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
                  ...
                  <div className="space-y-6">
                    <div className="inline-block bg-indigo-50 border border-indigo-100 rounded-xl px-4 py-2">
                      <h4 className="text-indigo-800 font-bold text-sm">Phase 1</h4>
                      <p className="text-indigo-600 text-xs font-semibold">Aptitude & Cognitive Screening</p>
                    </div>

                    <div className="space-y-4">
                      <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
                        <h5 className="font-bold text-navy-900 text-sm mb-3 flex items-center gap-2">
                        ...
                        <ul className="space-y-2 text-xs text-slate-600">
                          <li className="flex items-start gap-2">
                            ...
                            <span><strong>Quantitative:</strong> Time & Work, Speed & Distance, Probability, Data Interpretation.</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-indigo-500 mt-0.5">•</span>
                            <span><strong>Logical Reasoning:</strong> Seating arrangements, Syllogisms, Pattern recognition.</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-indigo-500 mt-0.5">•</span>
                            <span><strong>Verbal Ability:</strong> Reading comprehension, Sentence correction, Vocabulary.</span>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
                        ...
                        <ul className="space-y-2 text-xs text-slate-600">
                          <li className="flex items-start gap-2">
                            ...
                            <span>Practice minimum 50 high-frequency questions per topic.</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <Check className="w-3.5 h-3.5 text-teal-500 mt-0.5 shrink-0" />
                            <span>Take timed mock tests (target: {`<`}1 min per question).</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <Check className="w-3.5 h-3.5 text-teal-500 mt-0.5 shrink-0" />
                            <span>Memorize squares up to 30, cubes up to 15, and fraction percentages.</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  {/* Phase 2 Column */}
                  <div className="space-y-6">
                    <div className="inline-block bg-teal-50 border border-teal-100 rounded-xl px-4 py-2">
                      <h4 className="text-teal-800 font-bold text-sm">Phase 2</h4>
                      <p className="text-teal-600 text-xs font-semibold">Core Engineering & Tech Interviews</p>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
                        ...
                        <ul className="space-y-2 text-xs text-slate-600">
                          <li className="flex items-start gap-2">
                            ...
                            <span><strong>Data Structures:</strong> Arrays, Strings, HashMaps, Trees, Graphs.</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-teal-500 mt-0.5">•</span>
                            <span><strong>Algorithms:</strong> Sorting, Binary Search, Two Pointers, Dynamic Programming.</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <span className="text-teal-500 mt-0.5">•</span>
                            <span><strong>Core CS:</strong> Operating Systems, DBMS (SQL), Computer Networks, OOP concepts.</span>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
                        ...
                        <ul className="space-y-2 text-xs text-slate-600">
                          <li className="flex items-start gap-2">
                            <Check className="w-3.5 h-3.5 text-teal-500 mt-0.5 shrink-0" />
                            <span>Solve Top 100 Interview Questions on LeetCode/GeeksforGeeks.</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <Check className="w-3.5 h-3.5 text-teal-500 mt-0.5 shrink-0" />
                            <span>Practice writing code on a whiteboard or blank text editor.</span>
                          </li>
                          <li className="flex items-start gap-2">
                            <Check className="w-3.5 h-3.5 text-teal-500 mt-0.5 shrink-0" />
                            <span>Prepare 2 strong projects with STAR methodology explanations.</span>
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div className="p-6 border-t border-slate-100 bg-white shrink-0 flex items-center justify-between">
                ...
                <Link to="/candidate/aptitude">
                  <button
                    type="button"
                    className="px-6 py-2.5 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-sm shadow-md transition-all flex items-center gap-2 cursor-pointer"
                  >
