...
const CandidateRegistration = () => {
  ...
  const handleOAuthSignUp = async (provider) => {
    ...
    if (res?.success) {
      ...
      setErrors({ form: res?.message || 'OAuth sign-up failed' });
    }
  };
          ...
          <div className="lg:col-span-8 bg-white rounded-3xl p-6 sm:p-8 md:p-10 border border-slate-200/90 shadow-xl flex flex-col justify-center">
            ...
            <div className="mb-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-2.5 px-4 py-3 bg-white border border-slate-300 hover:bg-slate-50 hover:border-slate-400 rounded-xl text-xs font-bold text-slate-700 transition-all shadow-xs group"
              >
